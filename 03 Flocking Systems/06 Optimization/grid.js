//Here is our spatial search grid
...
function Grid(cellSize) {
    ...
    //Calculates cell's index based on x and y coordinates
    ...
    //This method reflects birds movments by removing the bird's index from the
    //cell it leaves and by adding it into the cell it arrives
    ...
    //Finds all birds into 9x9 square with center cell relative to the pos vector
